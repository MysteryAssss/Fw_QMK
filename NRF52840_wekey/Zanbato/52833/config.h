...
#define LED_MONITOR_PINS { J02, NO_PIN, NO_PIN, NO_PIN } // 4 pin for: USB, BLE1, BLE2, BLE3
#define LED_MONITOR_TYPE SINGLE

#define VDIV_PIN F28         // VBAT -> analog
#define BAT_VDIV_R1 (862.0F)    // 802k
#define BAT_VDIV_R2 (2000.0F)   // 2M

#define LED_CTRL_PIN F05       // CTRL EXT VCC
