...
#define LED_MONITOR_PINS { F15, F17, F20, F22 } // 4 pin for: USB, BLE1, BLE2, BLE3
#define LED_MONITOR_TYPE SINGLE

//#define VDIV_PIN NO_PIN         // VBAT -> analog
//#define BAT_VDIV_R1 (802.0F)    // 802k
//#define BAT_VDIV_R2 (2000.0F)   // 2M

#define LED_CTRL_PIN F31       // CTRL EXT VCC
#define LED_CTRL_PIN_ON 1         // 0 = Low; 1 = High
